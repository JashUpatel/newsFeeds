...
class NewsCard extends Component{
 ...
 render(props){
    ...
    // date.toString()
   let theDate =  Date( Date.parse('6/29/2011 4:52:48 PM UTC'));
    theDate.toLocaleString();  // "6/29/2011, 9:52:48 AM"
    return(
        <div className="col-md-4 col-lg-4 card-deck">
            <div className="card news" onClick={()=>this.clickHandler(item.link)}>
                ...
                <div className="card-img-overlay">
                    <h5 className='headerColor'>{item.source}</h5>
                </div>
